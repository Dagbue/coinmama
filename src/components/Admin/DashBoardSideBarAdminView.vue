...
<!--              <span class="links-name">News Letter</span>-->
<!--            </a>-->
<!--          </li>-->
<!--        </router-link>-->
        ...
        <router-link to="/user-information">
          <li>
            <a class="hover">
              <img src="../../assets/virtacc.svg" alt="logo" class="link-img" />
              <span class="links-name">Deposit Prompts</span>
            </a>
          </li>
        </router-link>

        <router-link to="/user-dashBoard-view">
          <li>
            <a class="hover">
              <img src="@/assets/pie-chart.svg" alt="logo" class="link-img" />
              <span class="links-name">Withdrawal Prompts</span>
            </a>
          </li>
        </router-link>
