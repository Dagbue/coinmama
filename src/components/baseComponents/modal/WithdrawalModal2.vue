    ...
    <dialog open>
      <div class="alpha">
        ...
        <div class="second-part">
          ...
          <p class="text-3">Kindly Note:For Faster Response you can contact support at <span>  <a href="mailto:support@cooinmama.com" class="para-last">support@cooinmama.com</a></span></p>
        </div>
